    ...
    <div class="media-tech__projects__container">
      ...
      <div class="grid__row">
        ...
        <grid-card 
          ...
          description="The creativity of human vs computer" 
          text="hwoeijelsifjeslfjels" 
          backgroundImage="/media-tech/image_2024-12-27_19-24-31.png" 
          heroImage="/media-tech/Afbeelding van WhatsApp op 2023-12-06 om 14.40.56_d946d109.jpg"/>
        <grid-card 
      ...
      <div class="grid__row">
        ...
        <grid-card 
          title="HCI" 
          description="Human Computer Interaction and Information Visualization" 
          text="hwoeijelsifjeslfjels" 
      ...
      <div class="grid__row">
        <grid-card title="Meta Media" description="Communicating using peculiar media" text="sdflkjd" backgroundImage="/media-tech/Schermafbeelding_2024-12-27_143717.png" heroImage="/media-tech/Schermafbeelding_2024-12-27_143717.png"/>
        <grid-card 
        ...
        >
          <div>
            <p>Individually created an algorithm to generate a 'Barbie' themed house in Minecraft, that is different in shape, size and features every time and is automatically built in the best location in the perimeter on the map. The house will not be placed on top of a tree: only on flat areas. If there is no flat area that is big enough for the house, it will change the size of the house. If it is too small, it will generate a platform (attached to the biggest flat area) to build the house on.</p>
            <p>In a team, I created an algorithm that generates a multi-level platform game in Minecraft, which is different every time you play it. Important features are:
              <ul>
        ...
        <div class="grid__row">
          <grid-card title="Research Fundamentals" description="hallo" text="hwoeijelsifjeslfjels" backgroundImage="/media-tech/image_2024-12-27_20-29-43.png" heroImage="/media-tech/Schermafbeelding_2024-12-27_143717.png"/>
          <grid-card 
          title="Robotics" 
        ...
        />
        <grid-card title="Sciences and Humanities" description="The opinion of what 'truth' is, according to various philosophers" text="hwoeijelsifjeslfjels" backgroundImage="/media-tech/Schermafbeelding_2024-12-27_143717.png" heroImage="/media-tech/Schermafbeelding_2024-12-27_143717.png"/>
        <grid-card title="Sound, Space and Interaction" description="Creating installations with the use of sound, using PureData" text="hwoeijelsifjeslfjels" backgroundImage="/media-tech/Schermafbeelding_2024-12-27_143717.png" heroImage="/media-tech/Schermafbeelding_2024-12-27_143717.png"/>
      </div>
      
      
      <div class="grid__row">
        <grid-card title="Strategies in Creative and Performing Arts" description="hallo" text="hwoeijelsifjeslfjels" backgroundImage="/media-tech/Schermafbeelding_2024-12-27_143717.png" heroImage="/media-tech/Schermafbeelding_2024-12-27_143717.png"/>
        <grid-card title="Graduation Project" description="hallo" text="hwoeijelsifjeslfjels" backgroundImage="/media-tech/Schermafbeelding_2024-12-27_143717.png" heroImage="/media-tech/Schermafbeelding_2024-12-27_143717.png"/>
      </div>
    </div>
  </section-component>
</template>
